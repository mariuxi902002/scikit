...
if __name__ == '__main__':
    data = pd.read_csv('./data/planta8-15-22.csv')
    print(data.head(5)) #imprimimos los 5 primeros datos
dt_1=data.drop(['Incidencia'],axis=1) #las featurus sin el target
dt_2 = data['Incidencia'] #obtenemos el target
dt_1 = StandardScaler().fit_transform(dt_1) #Normalizamnos los datos
X_train,X_test,y_train,y_test =train_test_split(dt_1,dt_2,test_size=0.30,random_state=42)
